...
def InSPyReNetV3_Res2Net101(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV3(res2net101_v1b_26w_4s(pretrained=pretrained), [64, 256, 512, 1024, 2048], depth, base_size, **kwargs)

def InSPyReNetV3_SwinS(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV3(SwinS(pretrained=pretrained), [96, 96, 192, 384, 768], depth, base_size, **kwargs)

def InSPyReNetV3_SwinT(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV3(SwinT(pretrained=pretrained), [96, 96, 192, 384, 768], depth, base_size, **kwargs)
    
def InSPyReNetV3_SwinB(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV3(SwinB(pretrained=pretrained), [128, 128, 256, 512, 1024], depth, base_size, **kwargs)

def InSPyReNetV3_SwinL(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV3(SwinL(pretrained=pretrained), [192, 192, 384, 768, 1536], depth, base_size, **kwargs)