...
def InSPyReNetV4_Res2Net50(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(res2net50_v1b_26w_4s(pretrained=pretrained), [64, 256, 512, 1024, 2048], depth, base_size, **kwargs)

def InSPyReNetV4_Res2Net101(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(res2net101_v1b_26w_4s(pretrained=pretrained), [64, 256, 512, 1024, 2048], depth, base_size, **kwargs)

def InSPyReNetV4_SwinS(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(SwinS(pretrained=pretrained), [96, 96, 192, 384, 768], depth, base_size, **kwargs)

def InSPyReNetV4_SwinT(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(SwinT(pretrained=pretrained), [96, 96, 192, 384, 768], depth, base_size, **kwargs)
    
def InSPyReNetV4_SwinB(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(SwinB(pretrained=pretrained), [128, 128, 256, 512, 1024], depth, base_size, **kwargs)

def InSPyReNetV4_SwinL(depth, pretrained, base_size, **kwargs):
    return InSPyReNetV4(SwinL(pretrained=pretrained), [192, 192, 384, 768, 1536], depth, base_size, **kwargs)