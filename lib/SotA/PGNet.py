...
class PGNet(nn.Module):
    def __init__(self, depth=64, pretrained=False, **kwargs):
        super(PGNet, self).__init__()
        self.decoder  = decoder()
        self.linear1 = nn.Conv2d(depth, 1, kernel_size=3, stride=1, padding=1)
        self.linear2 = nn.Conv2d(depth, 1, kernel_size=3, stride=1, padding=1)
        self.linear3 = nn.Conv2d(depth, 1, kernel_size=3, stride=1, padding=1)
        self.conv = nn.Conv2d(depth // 8,1,kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, sample):
        ...
        sample['pred'] = torch.sigmoid(pred1)
        return sample
