## this code has been brought from https://github.com/wuzhe71/CPD ##
...
class CPD_ResNet(nn.Module):
    ...
    def __init__(self, depth=32, pretrained=False, **kwargs):
        ...
        self.rfb2_1 = RFB(512, depth)
        self.rfb3_1 = RFB(1024, depth)
        self.rfb4_1 = RFB(2048, depth)
        self.agg1 = aggregation(depth)

        self.rfb2_2 = RFB(512, depth)
        self.rfb3_2 = RFB(1024, depth)
        self.rfb4_2 = RFB(2048, depth)
        self.agg2 = aggregation(depth)
