## this code has been brought from https://github.com/lartpang/MINet ##
...
class MINet_Res2Net50(nn.Module):
    def __init__(self, depth, pretrained=False, **kwargs):
        super(MINet_Res2Net50, self).__init__()
        # self.div_2, self.div_4, self.div_8, self.div_16, self.div_32 = Backbone_ResNet50_in3()
    ...
    def forward(self, in_data):
        ...
        in_data_2, in_data_4, in_data_8, in_data_16, in_data_32 = self.backbone.forward_alt(in_data['image'])
...
class MINet_SwinB(nn.Module):
    def __init__(self, **kwargs):
        super(MINet_SwinB, self).__init__()
        # self.div_2, self.div_4, self.div_8, self.div_16, self.div_32 = Backbone_ResNet50_in3()
        self.backbone = SwinB(pretrained=True)
        self.upsample_add = upsample_add
        self.upsample = cus_sample

        self.trans = AIM(iC_list=(128, 128, 256, 512, 1024), oC_list=(64, 64, 64, 64, 64))
    ...
    def forward(self, in_data):
        ...
        in_data_2, in_data_4, in_data_8, in_data_16, in_data_32 = self.backbone(in_data['image'])
        in_data_2 = F.interpolate(in_data_2, scale_factor=2, mode='bilinear', align_corners=True)
